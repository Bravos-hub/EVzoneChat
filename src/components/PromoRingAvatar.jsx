 ...
 * @param {Object} entity - Entity (person/group/channel) with promos array
 * @param {string} accentColor - Theme accent color
 * @param {Function} onClick - Click handler for ring menu
 * @param {number} size - Avatar size in pixels (default: 40)
 * @param {string} avatarSrc - Avatar image source (optional, falls back to entity.avatar)
 */
export default function PromoRingAvatar({ 
  entity, 
  accentColor, 
  onClick, 
  size = 40,
